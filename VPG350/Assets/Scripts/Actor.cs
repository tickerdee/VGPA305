...
public class Actor : MonoBehaviour {
	...
	void Update () 
	{
		...
		if (elapsedTime > OldTime)
		{
			switch (state)
			{
			//actor is idle until he receives input from mouse click
			case State.IDLE:
				break;
				
			//runs the same no matter how fast system is moving
			case State.MOVING:
	...
	{
		//runs actual pathfinder script and then resets the node
		//does it every second
